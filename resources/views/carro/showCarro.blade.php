    ...
    <div class="page-container">
        ...
        <br><x-barrageneral/>
            <section>
                                        ...
                                        @foreach ($carroItem->productos as $producto)
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="Eliminar producto">
                                                    @if(!$pedidoCerrado)
                                                        <form action="{{ route('carro.eliminarProducto', ['id_carro' => $carroItem->id_carro, 'id_producto' => $producto->id_producto]) }}" method="POST" class="inline">
                                                            @csrf
                                                            @method('DELETE')
                ...
                <br><center><a href="{{ url('/carro') }}" class="btn botonlistado">Volver al listado</a></center>
