...
<style>
  ...
  /* Quita apariencia nativa en botones con clase .btn-chip (para que se vean como links) */
  button.btn-chip{ -webkit-appearance:none; appearance:none; }

  /* Formularios de items admin dentro de la barra: en línea como links */
  ...
  /* Chips a 100% en móvil */
  @media (max-width: 991.98px){
    .btn-chip{ width:100%; justify-content:center; }
  }

  /* Dropdown compacto y UNIFICADO */
  .navbar .dropdown-menu{
    min-width:auto; width:auto; max-width:250px;
    font-size:.9rem; padding:4px 0;
  }
  /* Un único estilo para <a>.dropdown-item y <button>.dropdown-item */
  .navbar .dropdown-menu .dropdown-item{
    display:block; width:100%;
    padding:6px 10px; margin:0; text-align:left;
    font:inherit;
    color:#222 !important;                 /* neutraliza color azul de <a> */
    background:transparent !important;     /* neutraliza fondo de <button> */
  ...
  /* Evita herencias globales en el form del logout */
