...
<style>
  ...
  /* Unificamos estilo para <a>.dropdown-item y <button>.dropdown-item */
  .navbar .dropdown-menu .dropdown-item{
    padding:6px 10px; white-space:nowrap;
  }
  .navbar .dropdown-menu .dropdown-item:hover{ background-color:#f2f7ff; }

  /* Reset del form del logout para que no herede grids/flex globales */
  .navbar .dropdown-menu form{
    display:block; margin:0; padding:0;
  }
  /* El botón del form debe lucir como un <a>.dropdown-item */
  .navbar .dropdown-menu form .dropdown-item{
    display:block; width:100%; text-align:left;
    background:transparent; border:0; /* resto ya lo toma de .dropdown-item */
  }
